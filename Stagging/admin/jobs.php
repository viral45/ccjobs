...
<div class="page-header">
    <h1>
      ...
      <button type="button" id="add-btn" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Project</button></br><button type="button" id="add-btn" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Job</button>
      
    </h1>
    <ul>
    <li>ADD Archive Feature</li>
    <li>Default Show last 12 Months - Toggle to "Show All"</li>
    <li>Default Show lastest job first - Sort on Table Columns</li>
    <li>Add the ability to Add Projects</li>
    <li>??? The ability to filter/sort on Projects</li>
    <li>??? Show Project name in Table</li>
    <li>??? Show Job Status/stage in Table</li>
    </ul>
</div>

<div id="searchPanel" class="panel panel-default">
    <div class="panel-heading">
    	<h3 class="panel-title">Search</h3><div>Show Archived (completed) Jobs <input type="checkbox" checked data-toggle="toggle" data-size="xs"></div></div>
