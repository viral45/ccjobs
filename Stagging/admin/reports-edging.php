...
<div class="page-header">
    <h1>
      <span id="pageTitle">Reports (Edging)</span>
    ...
    <div class="panel-body">
        <form id="searchForm" class="form-horizontal">
            ...
            <div class="form-group">
            	<div class="col-sm-9">
                    ...
                    <select id="searchReportType" name="searchReportType" class="form-control">
						<option value="incomplete">Jobs (incomplete)</option>
				...
				<div class="col-sm-3">
					...
					<select id="sortorder" name="sortorder" class="form-control">
						...
						<option value="tblJobMaterial.JobMaterialID">Sent From Draftsman (Oldest to Newest)</option>
						<option value="tblJobMaterial.JobMaterialID DESC">Sent From Draftsman (Newest to Oldest)</option>
						
						<option value="tblJobMaterial.EdgingDateCompleted">Date Completed (Oldest to Newest)</option>
						<option value="tblJobMaterial.EdgingDateCompleted DESC">Date Completed (Newest to Oldest)</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group" id="searchfilters">
				...
				<div class="col-sm-4">
					<label for="searchCompletedBy">Completed By</label>
                    <select id="searchCompletedBy" name="searchCompletedBy" class="form-control">
...
<script type='text/javascript'>
	...
	$(document).ready(function(){
		...
		function showReport(){
			...
			var reportpage = "reports/edging-" + $("#searchReportType").val() + ".php";
