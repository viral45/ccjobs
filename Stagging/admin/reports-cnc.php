...
<div class="page-header">
    <h1>
      <span id="pageTitle">Reports (CNC)</span>
            ...
            <div class="form-group">
				...
				<div class="col-sm-3">
					...
					<select id="sortorder" name="sortorder" class="form-control">
						...
						<option value="tblJobMaterial.CNCDateCompleted">Date Completed (Oldest to Newest)</option>
						<option value="tblJobMaterial.CNCDateCompleted DESC">Date Completed (Newest to Oldest)</option>
                    </select>
                </div>
            </div>
...
<script type='text/javascript'>
	...
	$(document).ready(function(){
		...
		function showReport(){
			...
			var reportpage = "reports/cnc-" + $("#searchReportType").val() + ".php";
