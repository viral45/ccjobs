...
<div id="print-content">
    ...
    <h1>
        <span id="pageTitle">Assembler Jobs (started)</span>
    ...
    <div class="table">
        ...
        <?php
			$query = "SELECT Count(tblJob.JobID) FROM tblJob INNER JOIN tblJobTask ON tblJob.JobID = tblJobTask.JobID WHERE tblJob.Deleted = 0 AND tblJobTask.DateStarted IS NOT NULL AND tblJobTask.ReadyForCheck = 0 AND tblJobTask.DateChecked IS NULL ORDER BY tblJob.JobID";
