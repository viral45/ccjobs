...
<div id="print-content">
    ...
    <h1>
        <span id="pageTitle">Edging Jobs (incomplete)</span>
    ...
    <div class="table">
        ...
        <?php
			$query = "SELECT Count(tblJob.JobID) FROM tblJob INNER JOIN tblJobMaterial ON tblJob.JobID = tblJobMaterial.JobID WHERE tblJobMaterial.CNCDateCompleted IS NOT NULL AND tblJobMaterial.EdgingDateCompleted IS NULL AND tblJobMaterial.BoardQuantity <> 0 ORDER BY tblJob.JobID, tblJobMaterial.IsCarcass";
        ...
        ?> 
            ...
            <table class="table table-striped">
                ...
                <tbody>
                	...
                	$query = "SELECT tblJob.JobID, tblJob.JobAddress, tblJobMaterial.BoardDescription, tblJobMaterial.BoardType, tblJobMaterial.BoardQuantity, tblJobMaterial.EdgingNotes FROM tblJob INNER JOIN tblJobMaterial ON tblJob.JobID = tblJobMaterial.JobID WHERE tblJobMaterial.CNCDateCompleted IS NOT NULL AND tblJobMaterial.EdgingDateCompleted IS NULL AND tblJobMaterial.BoardQuantity <> 0 ORDER BY $sortorder";
					$result = $mysqli->query($query);
