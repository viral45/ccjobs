...
<div id="print-content">
    <div>
        <h1>
            <span id="pageTitle">Installer Jobs (missing items)</span>
    ...
    <div class="table">
        ...
        <?php
			$query = "SELECT Count(tblJob.JobID) FROM tblJob INNER JOIN tblJobTaskInstall ON tblJob.JobID = tblJobTaskInstall.JobID WHERE tblJob.Deleted = 0 AND (tblJobTaskInstall.MissingItems IS NOT NULL AND tblJobTaskInstall.MissingItems != '') AND tblJobTaskInstall.MissingItemsComplete = 0 $where GROUP BY tblJob.JobID";
