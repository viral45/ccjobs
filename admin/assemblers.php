...
<div class="page-header">
    <h1>
      ...
      <button type="button" id="assembler-staff-add" class="btn btn-primary pull-right" style="margin-left:1%;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>Add Task</button>
