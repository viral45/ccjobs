...
<div class="page-header">
    <h1>
      <span id="pageTitle">Reports (Assemblers)</span>
            ...
            <div class="form-group">
            	<div class="col-sm-9">
                    ...
                    <select id="searchReportType" name="searchReportType" class="form-control">
						...
						<option value="started">Jobs (started)</option>
						<option value="check">Jobs (check required)</option>
				...
				<div class="col-sm-3">
					...
					<select id="sortorder" name="sortorder" class="form-control">
						...
						<option value="tblJobTask.DateStarted">Date Started (Oldest to Newest)</option>
						<option value="tblJobTask.DateStarted DESC">Date Started (Newest to Oldest)</option>
					</select>
				</div>
            </div>
...
<script type='text/javascript'>
	...
	$(document).ready(function(){
		...
		function showReport(){
			...
			var reportpage = "reports/assemblers-" + $("#searchReportType").val() + ".php";
